...
export function InvestorProfileForm({ investor }: { investor: Investor }) {
  ...
  return (
    <details className="panel mb-4 overflow-hidden">
      <summary className="flex cursor-pointer list-none items-center gap-3 p-4 text-[14px] font-semibold"><span className="grid size-8 place-items-center rounded-lg bg-[#4d7cfe]/10 text-[#8fb0ff]"><UserRoundPen size={14} /></span>Editar inversionista<span className="ml-auto text-[12px] font-normal text-[#6b7594]">Perfil y acceso</span></summary>
      <div className="border-t border-[#232b45] p-5">
        ...
        <div className="mt-6 border-t border-[#342126] pt-5">
          <p className="text-[13px] font-semibold text-[#ff8296]">Eliminar inversionista</p><p className="mt-1 text-[12px] text-[#7a7f9e]">Escribe exactamente el correo. También se eliminarán sus participaciones, pagos y documentos privados.</p>
