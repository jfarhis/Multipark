...
export function InvestorProfileForm({ investor }: { investor: Investor }) {
  ...
  return (
    <details className="panel mb-4 overflow-hidden">
      <summary className="flex cursor-pointer list-none items-center gap-3 p-4 text-[11px] font-semibold"><span className="grid size-8 place-items-center rounded-lg bg-[#8b72ff]/10 text-[#aa99ff]"><UserRoundPen size={14} /></span>Editar inversionista<span className="ml-auto text-[9px] font-normal text-[#69766e]">Perfil y acceso</span></summary>
      <div className="border-t border-[#202b25] p-5">
        ...
        <div className="mt-6 border-t border-[#342126] pt-5">
          <p className="text-[10px] font-semibold text-[#ff8296]">Eliminar inversionista</p><p className="mt-1 text-[9px] text-[#7b6c70]">Escribe exactamente el correo. También se eliminarán sus participaciones, pagos y documentos privados.</p>
