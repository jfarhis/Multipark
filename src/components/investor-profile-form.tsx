...
export function InvestorProfileForm({ investor }: { investor: Investor }) {
  ...
  return (
    <details className="panel mb-4 overflow-hidden">
      <summary className="flex cursor-pointer list-none items-center gap-3 p-4 text-[11px] font-semibold"><span className="grid size-8 place-items-center rounded-lg bg-[#ff7a2f]/10 text-[#ffab63]"><UserRoundPen size={14} /></span>Editar inversionista<span className="ml-auto text-[9px] font-normal text-[#96725f]">Perfil y acceso</span></summary>
      <div className="border-t border-[#35201a] p-5">
        ...
        <div className="mt-6 border-t border-[#342126] pt-5">
          <p className="text-[10px] font-semibold text-[#ff8296]">Eliminar inversionista</p><p className="mt-1 text-[9px] text-[#8a6a60]">Escribe exactamente el correo. También se eliminarán sus participaciones, pagos y documentos privados.</p>
