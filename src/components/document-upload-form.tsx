...
export function DocumentUploadForm({ data }: { data: DashboardData }) {
  ...
  return (
    <section className="panel mb-4 p-5">
      ...
      </form> : <div className="mt-5 rounded-xl border border-[#2a342f] bg-[#101713] p-4 text-[10px] text-[#7f8b84]">Primero crea un proyecto para poder agregar documentos.</div>}
    </section>
  );
}
