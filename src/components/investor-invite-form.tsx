  ...
  return (
    <section id="invite-investor" className="panel mt-4 p-5">
      <div className="flex items-start gap-3">
        ...
        <div><p className="text-[12px] font-semibold">Agregar un inversionista</p><p className="mt-1 text-[10px] text-[#7c86a6]">Crea su registro y envía una invitación segura por correo.</p></div>
      </div>
