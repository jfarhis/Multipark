  ...
  return (
    <section id="invite-investor" className="panel mt-4 p-5">
      <div className="flex items-start gap-3">
        <span className="grid size-9 place-items-center rounded-xl bg-[#ff7a2f]/10 text-[#ffa35c]"><MailPlus size={16} /></span>
        <div><p className="text-[12px] font-semibold">Agregar un inversionista</p><p className="mt-1 text-[10px] text-[#a3806f]">Crea su registro y envía una invitación segura por correo.</p></div>
      </div>
